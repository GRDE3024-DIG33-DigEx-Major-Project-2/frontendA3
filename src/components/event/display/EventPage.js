...
function EventPage() {
   ...
   */
  const { fetchStatus } = useContext(SearchEventsContext);
  ...
  const [event, setEvent] = useState(
    location.state ? location.state.event : null
  );
    ...
    return (
      <div className="event-preview">
        <Tooltip title={tooltipMessage}>
          <div
            className="event-prev-card-icon-share"
          ...
          (user.type === "attendee" ? (
            ...
            >
              <div className="event-prev-card-icon-bookmark">
                <div
                  id={favourite ? "evpage-bookmark-selected" : "ev-bookmark"}
