  ...
  return (
    <div className="App">
      ...
      <LoadingProvider>
        ...
        <Route path={PATHS.SIGN_UP_ATTENDEE} element={<SignUpGuest />} />
        <Route path={PATHS.SIGN_UP_ORGANISER} element={<SignUpOrganiser />} />
        <Route path={PATHS.CREATE_EVENT} element={<CreateEvent />} />
        <Route path={PATHS.EDIT_EVENT} element={<EditEvent />} />
        <Route path={PATHS.PAGE_NOT_FOUND} element={<h1 className="not-found">Page Not Found</h1>} />
      </Routes>          
        </SearchEventFiltersProvider>
      </SearchEventsProvider>  
      </LoadingProvider>
